...
# from task.model.mysql import Hotel, initDb
from task.model.mongo import Hotel, initDb
...
class SpiderWyn88(SpiderHotelOrigin):
    ...
    # @store(withMysql(WDB), Hotel.insert, update=True, method='MANY')
    @store(withMongo(WDB), Hotel.insert, update=True, method='MANY')
    @timelimit(3)
