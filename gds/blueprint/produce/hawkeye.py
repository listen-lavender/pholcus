...
values
    ...
    (0, 'article', 0, 'module', '', 'requGet', '', 'import', 'from webcrawl.request import', null, 'requGet', 'function'),
    (0, 'article', 0, 'module', '', 'requPost', '', 'import', 'from webcrawl.request import', null, 'requPost', 'function'),
